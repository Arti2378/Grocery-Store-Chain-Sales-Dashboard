...
This dashboard was built to help a grocery chain track sales performance, promotions and customer loyalty across multiple stores.
...
## 🔍 Key Insights 
- Over 80% of total sales are discount driven indicating strong reliance on promotions.
- Seasonal peaks observed in October (2023 & 2024) and a shift to March (2025).  
...
- Loyalty data showed City Fresh Store consistently drove strong customer engagement.
